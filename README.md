...
* Les scripts ont été écrits dans la [variante SQLite](https://www.tutorialspoint.com/sqlite/index.htm) du langage [SQL](https://fr.wikipedia.org/wiki/Structured_Query_Language) (avec l'assistance occasionnelle de [Gemini Flash 3.5](https://blog.google/intl/fr-fr/nouveautes-produits/io-gemini-3-5/#gemini-3-5-flash)), en [Bourne shell](https://fr.wikipedia.org/wiki/Bourne_shell) ou en Python.
